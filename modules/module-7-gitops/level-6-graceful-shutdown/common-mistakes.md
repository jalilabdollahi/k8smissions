# Common Mistakes - Level 6: Requests Dropped During Rollout
...
**What players try:**
Players use `kubectl edit` to hot-fix Requests Dropped During Rollout and move on.
...
**Correct approach:**
Use revision history, sync status, or a single reversible change, then validate. End goal: Rolling update completes with zero dropped connections
