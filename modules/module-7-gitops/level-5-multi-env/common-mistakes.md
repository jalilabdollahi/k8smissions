# Common Mistakes - Level 5: Dev Config in Production
...
**What players try:**
Players use `kubectl edit` to hot-fix Dev Config in Production and move on.

**Why it fails:**
GitOps and release tools will overwrite that drift on the next sync, reconcile, or Helm upgrade.

**Correct approach:**
Make the change in the declarative source that owns the resource. In this level the key focus is Kustomize overlays and patch targeting.
