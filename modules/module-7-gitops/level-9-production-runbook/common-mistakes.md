# Common Mistakes - Level 9: Runbook: DB Migration Rollout
...
**What players try:**
Players use `kubectl edit` to hot-fix Runbook: DB Migration Rollout and move on.

**Why it fails:**
GitOps and release tools will overwrite that drift on the next sync, reconcile, or Helm upgrade.

**Correct approach:**
Make the change in the declarative source that owns the resource. In this level the key focus is environment promotion and config drift.
