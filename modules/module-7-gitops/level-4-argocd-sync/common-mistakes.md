# Common Mistakes - Level 4: ArgoCD Out of Sync
...
**What players try:**
Players use `kubectl edit` to hot-fix ArgoCD Out of Sync and move on.
...
**Correct approach:**
Use revision history, sync status, or a single reversible change, then validate. End goal: argocd app get webapp-app → Synced, Healthy
