# Common Mistakes - Level 9: Off-Balance Canary
...
**What players try:**
Players patch an individual pod in Off-Balance Canary because it is the easiest object to see.
...
**Correct approach:**
Use the smallest reversible change, verify behavior, then continue. Success target: 90% requests hit stable, ~10% hit canary
