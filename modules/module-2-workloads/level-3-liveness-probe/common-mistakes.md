# Common Mistakes - Level 3: The Restart Loop
...
**What players try:**
Players patch an individual pod in The Restart Loop because it is the easiest object to see.
...
**Correct approach:**
Use the smallest reversible change, verify behavior, then continue. Success target: Pods Running, RESTARTS count not increasing
