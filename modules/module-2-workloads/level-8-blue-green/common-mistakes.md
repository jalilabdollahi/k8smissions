# Common Mistakes - Level 8: Blue-Green Gone Wrong
...
**What players try:**
Players patch an individual pod in Blue-Green Gone Wrong because it is the easiest object to see.
...
**Correct approach:**
Use the smallest reversible change, verify behavior, then continue. Success target: curl to service returns green deployment response
