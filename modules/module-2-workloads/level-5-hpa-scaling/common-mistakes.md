# Common Mistakes - Level 5: Autoscaler Blind
...
**What players try:**
Players patch an individual pod in Autoscaler Blind because it is the easiest object to see.
...
**Correct approach:**
Verify the workload from the controller perspective and the traffic perspective. In this level the focus is HPA signals and scaling boundaries.
...
**Correct approach:**
Use the smallest reversible change, verify behavior, then continue. Success target: kubectl get hpa → TARGETS shows actual CPU%, not <unknown>
