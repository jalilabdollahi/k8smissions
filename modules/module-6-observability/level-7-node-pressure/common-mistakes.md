# Common Mistakes - Level 7: Node Under Pressure
...
**What players try:**
Players use just one command in Node Under Pressure, such as logs or `kubectl top`, and stop there.
...
**Correct approach:**
Build a timeline for node pressure and eviction signals using events, previous logs, and current status together.
