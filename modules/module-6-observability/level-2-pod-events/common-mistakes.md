# Common Mistakes - Level 2: Read the Events
...
**What players try:**
Players use just one command in Read the Events, such as logs or `kubectl top`, and stop there.
...
**Correct approach:**
After the fix, explain what the signal should look like in a healthy cluster. Success target: Pod Running
