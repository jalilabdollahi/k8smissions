# Common Mistakes - Level 3: Who's Eating All the CPU?
...
**What players try:**
Players use just one command in Who's Eating All the CPU?, such as logs or `kubectl top`, and stop there.
...
**Correct approach:**
Build a timeline for the real source of the failure using events, previous logs, and current status together.
...
**Correct approach:**
After the fix, explain what the signal should look like in a healthy cluster. Success target: Node CPU back under 70%, other pods healthy
