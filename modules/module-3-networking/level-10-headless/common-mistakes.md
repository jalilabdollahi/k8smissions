# Common Mistakes - Level 10: StatefulSet Can't Reach Itself
...
**What players try:**
Players see Running pods in StatefulSet Can't Reach Itself and assume networking must be fine.
...
**Correct approach:**
Trace the request path end-to-end with the focus on headless Service DNS. Confirm that each hop points to the next one correctly.
