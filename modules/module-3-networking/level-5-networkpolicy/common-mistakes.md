# Common Mistakes - Level 5: NetworkPolicy Too Strict
...
**What players try:**
Players see Running pods in NetworkPolicy Too Strict and assume networking must be fine.
...
**Correct approach:**
Trace the request path end-to-end with the focus on Ingress path and backend mapping. Confirm that each hop points to the next one correctly.
