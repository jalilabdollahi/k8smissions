# Common Mistakes - Level 9: LoadBalancer Stuck Pending
...
**What players try:**
Players see Running pods in LoadBalancer Stuck Pending and assume networking must be fine.
...
**Correct approach:**
Trace the request path end-to-end with the focus on NodePort reachability. Confirm that each hop points to the next one correctly.
