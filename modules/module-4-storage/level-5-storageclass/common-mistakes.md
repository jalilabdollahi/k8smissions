# Common Mistakes - Level 5: StorageClass Missing
...
**What players try:**
Players look only at application logs in StorageClass Missing and skip PV/PVC status, mount definitions, or storage class details.
