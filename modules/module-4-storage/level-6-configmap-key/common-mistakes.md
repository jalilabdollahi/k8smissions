# Common Mistakes - Level 6: Missing Config Key
...
**What players try:**
Players look only at application logs in Missing Config Key and skip PV/PVC status, mount definitions, or storage class details.
