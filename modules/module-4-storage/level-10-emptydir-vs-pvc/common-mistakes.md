# Common Mistakes - Level 10: Data Lost on Restart
...
**What players try:**
Players look only at application logs in Data Lost on Restart and skip PV/PVC status, mount definitions, or storage class details.
...
**Correct approach:**
Start from PVC/PV binding: inspect the claim, the backing volume or class, and how the pod mounts it.
