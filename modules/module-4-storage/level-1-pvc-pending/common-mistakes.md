# Common Mistakes - Level 1: PVC Won't Bind
...
**What players try:**
Players look only at application logs in PVC Won't Bind and skip PV/PVC status, mount definitions, or storage class details.
