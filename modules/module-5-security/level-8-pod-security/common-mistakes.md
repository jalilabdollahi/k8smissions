# Common Mistakes - Level 8: Restricted Policy Violation
...
**What players try:**
Players solve Restricted Policy Violation by granting broad permissions or relaxing security constraints too far.
...
**Correct approach:**
Verify subject, verb, resource, and scope explicitly. In this level the main focus is pod security settings.
