# Common Mistakes - Level 4: Locked Down Too Hard
...
**What players try:**
Players solve Locked Down Too Hard by granting broad permissions or relaxing security constraints too far.
...
**Correct approach:**
Verify subject, verb, resource, and scope explicitly. In this level the main focus is the real source of the failure.
