# Common Mistakes - Level 8: App Takes 60s to Start
...
**What players try:**
Players use just one command in App Takes 60s to Start, such as logs or `kubectl top`, and stop there.
...
**Correct approach:**
Build a timeline for probe behavior and timing using events, previous logs, and current status together.
