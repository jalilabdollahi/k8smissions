# Common Mistakes - Level 1: Helm Values Gone Wrong
...
**What players try:**
Players use `kubectl edit` to hot-fix Helm Values Gone Wrong and move on.
...
**Correct approach:**
Use revision history, sync status, or a single reversible change, then validate. End goal: helm status myapp → deployed, pod uses correct image tag
