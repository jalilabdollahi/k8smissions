# Common Mistakes - Level 3: Wrong Overlay Applied
...
**What players try:**
Players use `kubectl edit` to hot-fix Wrong Overlay Applied and move on.
...
**Correct approach:**
Use revision history, sync status, or a single reversible change, then validate. End goal: Deployment replicas = 2 (staging), not 10 (production)
