# Common Mistakes - Level 8: Connection Refused
...
**What players try:**
Players see Running pods in Connection Refused and assume networking must be fine.
...
**Correct approach:**
Validate through the same path the workload is supposed to use. End goal: curl / connection from another pod succeeds
