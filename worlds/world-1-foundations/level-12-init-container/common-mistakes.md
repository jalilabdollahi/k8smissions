# Common Mistakes - Level 12: Waiting Forever
...
**What players try:**
Players see Running pods in Waiting Forever and assume networking must be fine.
...
**Correct approach:**
Trace the request path end-to-end with the focus on Service selectors and endpoints. Confirm that each hop points to the next one correctly.
...
**Correct approach:**
Validate through the same path the workload is supposed to use. End goal: Init container exits 0, main container starts and runs
