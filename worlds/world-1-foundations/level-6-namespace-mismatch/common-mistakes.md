# Common Mistakes - Level 6: Lost in Space
...
**What players try:**
Players see Running pods in Lost in Space and assume networking must be fine.
...
**Correct approach:**
Validate through the same path the workload is supposed to use. End goal: Pod and Service exist in k8smissions namespace and are reachable
