# Common Mistakes - Level 6: Random Logout
...
**What players try:**
Players see Running pods in Random Logout and assume networking must be fine.
...
**Correct approach:**
Trace the request path end-to-end with the focus on session affinity behavior. Confirm that each hop points to the next one correctly.
