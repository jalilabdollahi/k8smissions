# Common Mistakes - Level 9: Critical Pods Can't Schedule
...
**What players try:**
Players solve Critical Pods Can't Schedule by granting broad permissions or relaxing security constraints too far.
...
**Correct approach:**
Verify subject, verb, resource, and scope explicitly. In this level the main focus is scheduling and disruption safety controls.
