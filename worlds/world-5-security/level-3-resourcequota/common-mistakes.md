# Common Mistakes - Level 3: Quota Exceeded
...
**What players try:**
Players solve Quota Exceeded by granting broad permissions or relaxing security constraints too far.
...
**Correct approach:**
Verify subject, verb, resource, and scope explicitly. In this level the main focus is quota and namespace limits.
