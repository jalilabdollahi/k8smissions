# Common Mistakes - Level 4: Shared Storage Chaos
...
**What players try:**
Players look only at application logs in Shared Storage Chaos and skip PV/PVC status, mount definitions, or storage class details.
