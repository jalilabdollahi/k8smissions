# Common Mistakes - Level 2: Wrong Mount Path
...
**What players try:**
Players look only at application logs in Wrong Mount Path and skip PV/PVC status, mount definitions, or storage class details.
