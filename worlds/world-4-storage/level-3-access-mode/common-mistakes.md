# Common Mistakes - Level 3: Only One Can Write
...
**What players try:**
Players look only at application logs in Only One Can Write and skip PV/PVC status, mount definitions, or storage class details.
