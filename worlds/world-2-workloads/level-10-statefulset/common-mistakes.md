# Common Mistakes - Level 10: Database Needs Identity
...
**What players try:**
Players patch an individual pod in Database Needs Identity because it is the easiest object to see.
...
**Correct approach:**
Use the smallest reversible change, verify behavior, then continue. Success target: kubectl get statefulset, pods have predictable names (db-0, db-1)
