# Common Mistakes - Level 6: Zero-Downtime Gone Wrong
...
**What players try:**
Players patch an individual pod in Zero-Downtime Gone Wrong because it is the easiest object to see.
...
**Correct approach:**
Verify the workload from the controller perspective and the traffic perspective. In this level the focus is traffic shifting and safe rollout strategy.
...
**Correct approach:**
Use the smallest reversible change, verify behavior, then continue. Success target: Rolling update completes with at least 1 pod always Running
