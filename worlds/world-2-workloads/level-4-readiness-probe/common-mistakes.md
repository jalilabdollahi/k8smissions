# Common Mistakes - Level 4: Too Eager
...
**What players try:**
Players patch an individual pod in Too Eager because it is the easiest object to see.
...
**Correct approach:**
Use the smallest reversible change, verify behavior, then continue. Success target: Pods show Ready 1/1 only after startup; no 502s during rollout
